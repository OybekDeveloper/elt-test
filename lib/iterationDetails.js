...
const crudPage = [
  ...
  { id: 19, title: "Создать фон", path: "/createBackground" },
  { id: 20, title: "Обновить фон", path: "/changeBackground" },
  { id: 21, title: "Редактировать контакты", path: "/changeContact" },
  { id: 22, title: "Просмотр запросов", path: "/selectReview" },
];
